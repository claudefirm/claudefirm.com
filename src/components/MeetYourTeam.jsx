...
const AUTONOMY_COLORS = {
  ...
  'Auto + review': 'bg-green-500/10 text-green-400 border-green-500/20',
    ...
    <SectionWrapper id="team" variant="darker" noisy>
      <FadeIn>
        ...
        <h2 className="font-display font-bold text-3xl md:text-[2.75rem] leading-[1.1] tracking-tight text-white max-w-2xl">
          ...
          <span className="text-slate-light">You keep decision power.</span>
        </h2>
        <p className="mt-5 text-slate-light text-lg leading-relaxed max-w-[640px]">
          Four AI agents that handle intake, billing, collections, and marketing
          for your firm. They work nights, weekends, and holidays. They never
          forget a follow-up. They never call in sick. And they can't do
