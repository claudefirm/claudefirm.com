          ...
          <div className="lg:col-span-7">
            ...
            <FadeIn delay={200}>
              <p className="mt-4 text-sm italic text-brass/60 max-w-[640px]">
                ...
                measured baseline replaces the design-target ranges below once
                the 90-minute observation lands.
              </p>
            </FadeIn>
            ...
            <FadeIn delay={240}>
              <div className="mt-12">
                <WaitlistForm dark />
                <div className="mt-5">
                  <Button variant="ghost" href="#problem">Where the dollars hide &darr;</Button>
                </div>
              </div>
            </FadeIn>
          </div>
